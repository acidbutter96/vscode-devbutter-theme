...
function getColors(theme) {
  ...
  switch(theme) {
    ...
    case "dark":
      ...
      // Temp override until Primitives are updated
      darkColors.fg.default = "#FFFFFF";
      darkColors.fg.muted = "#79E59B";
      darkColors.accent.fg = "#28B1BE";

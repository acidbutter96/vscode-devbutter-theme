...
function getTheme({ theme, name }) {
    ...
    return {
        ...
        colors: {
            ...
            "editorLineNumber.foreground": lightDark(
                scale.gray[4],
                scale.gray[4],
            ),
            ...
            "editorWhitespace.foreground": lightDark(
                scale.gray[3],
                scale.gray[5],
            ),
            ...
            "debugConsole.infoForeground": lightDark(
                scale.gray[6],
                scale.gray[3],
            ),
            ...
            "debugConsole.errorForeground": lightDark(
                scale.red[5],
                scale.red[2],
            ),
            ...
            "debugTokenExpression.name": lightDark(
                scale.blue[6],
                scale.blue[2],
            ),
            ...
            "debugTokenExpression.string": lightDark(
                scale.blue[8],
                scale.blue[1],
            ),
            "debugTokenExpression.boolean": lightDark(
                scale.green[6],
                scale.green[2],
            ),
            "debugTokenExpression.number": lightDark(
                scale.green[6],
                scale.green[2],
            ),
            "debugTokenExpression.error": lightDark(scale.red[6], scale.red[2]),

            "symbolIcon.arrayForeground": lightDark(
                scale.orange[6],
                scale.orange[3],
            ),
            "symbolIcon.booleanForeground": lightDark(
                scale.blue[6],
                scale.blue[3],
            ),
            "symbolIcon.classForeground": lightDark(
                scale.orange[6],
                scale.orange[3],
            ),
            "symbolIcon.colorForeground": lightDark(
                scale.blue[8],
                scale.blue[2],
            ),
            ...
            "symbolIcon.eventForeground": lightDark(
                scale.gray[6],
                scale.gray[4],
            ),
            "symbolIcon.fieldForeground": lightDark(
                scale.orange[6],
                scale.orange[3],
            ),
            "symbolIcon.fileForeground": lightDark(
                scale.yellow[6],
                scale.yellow[3],
            ),
            ...
            "symbolIcon.keywordForeground": lightDark(
                scale.red[6],
                scale.red[3],
            ),
            ...
            "symbolIcon.moduleForeground": lightDark(
                scale.red[6],
                scale.red[3],
            ),
            "symbolIcon.namespaceForeground": lightDark(
                scale.red[6],
                scale.red[3],
            ),
            "symbolIcon.nullForeground": lightDark(
                scale.blue[6],
                scale.blue[3],
            ),
            "symbolIcon.numberForeground": lightDark(
                scale.green[6],
                scale.green[3],
            ),
            ...
            "symbolIcon.operatorForeground": lightDark(
                scale.blue[8],
                scale.blue[2],
            ),
            ...
            "symbolIcon.referenceForeground": lightDark(
                scale.blue[6],
                scale.blue[3],
            ),
            "symbolIcon.snippetForeground": lightDark(
                scale.blue[6],
                scale.blue[3],
            ),
            "symbolIcon.stringForeground": lightDark(
                scale.blue[8],
                scale.blue[2],
            ),
            ...
            "symbolIcon.textForeground": lightDark(
                scale.blue[8],
                scale.blue[2],
            ),

...
function getTheme({ theme, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "editor.findMatchHighlightBackground"   : alpha(scale.pink[1], 0.5),
      ...
      "debugConsole.warningForeground": lightDark( scale.pink[6], scale.pink[3]),
      "debugConsole.errorForeground": lightDark( scale.red[5], scale.red[2]),
      "debugConsole.sourceForeground": lightDark( scale.pink[5], scale.pink[2]),
      ...
      "symbolIcon.arrayForeground": lightDark( scale.pink[6], scale.pink[3]),
      "symbolIcon.booleanForeground": lightDark( scale.blue[6], scale.blue[3]),
      "symbolIcon.classForeground": lightDark( scale.pink[6], scale.pink[3]),
      ...
      "symbolIcon.enumeratorForeground": lightDark( scale.pink[6], scale.pink[3]),
      ...
      "symbolIcon.fieldForeground": lightDark( scale.pink[6], scale.pink[3]),
      "symbolIcon.fileForeground": lightDark( scale.pink[6], scale.pink[3]),
      "symbolIcon.folderForeground": lightDark( scale.pink[6], scale.pink[3]),
      "symbolIcon.functionForeground": lightDark( scale.purple[6], scale.purple[3]),
      "symbolIcon.interfaceForeground": lightDark( scale.pink[6], scale.pink[3]),
      ...
      "symbolIcon.objectForeground": lightDark( scale.pink[6], scale.pink[3]),
      "symbolIcon.operatorForeground": lightDark( scale.blue[8], scale.blue[2]),
      "symbolIcon.packageForeground": lightDark( scale.pink[6], scale.pink[3]),
      "symbolIcon.propertyForeground": lightDark( scale.pink[6], scale.pink[3]),
      ...
      "symbolIcon.structForeground": lightDark( scale.pink[6], scale.pink[3]),
      ...
      "symbolIcon.variableForeground": lightDark( scale.pink[6], scale.pink[3]),
      ...
      'terminal.ansiBrightYellow': color.ansi.pinkBright,
      ...
      "editorBracketHighlight.foreground3": lightDark(scale.pink[5], scale.pink[2]),
    ...
    tokenColors: [
      ...
      },
      {
        ...
        settings: {
          foreground: lightDark(scale.pink[6], scale.pink[2])
        },
      },
      {
        scope: [
      ...
      },
      {
        ...
        settings: {
          background: lightDark(scale.pink[1], scale.pink[8]),
          foreground: lightDark(scale.pink[6], scale.pink[2])
        },
      },
      {
